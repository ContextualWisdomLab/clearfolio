...
## 2026-09-10 - String.split 최적화
**Learning:** `String.split()`과 Java Stream을 사용하여 간단한 구분 기호 토큰을 파싱하는 것은 불필요한 배열 할당과 함수형 오버헤드를 발생시킵니다.
**Action:** 수동 루프와 `indexOf()`, `substring()`을 사용하여 GC 압박을 줄입니다.
