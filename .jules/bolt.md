...
## 2026-08-15 - 벤치마크 검증의 중요성
**Learning:** 단위 테스트나 Checkstyle 통과만으로는 성능 최적화(예: 할당량 감소, 처리량 개선)를 입증하기에 부족합니다. 보안과 관련된 파서의 경우 특히 중요합니다.
**Action:** 보안에 중요한 파서 복잡성을 수정할 때는 JMH와 같은 벤치마크, 변형 한계, 유의미한 성능 향상 기준 등을 통해 성능 개선을 명확히 측정하고 입증해야 합니다. 이와 관련된 지표가 없으면 최적화 시도를 거부될 수 있습니다.
