...
## 2026-08-24 - DOM 리렌더링 최적화
**Learning:** 반복문 내에서 직접 DOM 요소(예: `appendChild`)를 삽입하면 브라우저의 reflow/repaint가 발생하여 성능을 저하시킬 수 있습니다.
**Action:** 다수의 요소를 삽입할 때는 `DocumentFragment`를 사용하여 메모리 내에서 일괄 처리한 후 DOM에 한 번에 삽입하여 렌더링 성능을 개선합니다.
