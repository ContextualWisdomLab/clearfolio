...
## 2024-05-24 - setBusyState 적용을 통한 접근성 향상
**Learning:** 비동기 버튼에서 로딩 텍스트를 수동으로 변경하면 ARIA 속성이 유실될 수 있습니다.
**Action:** DOM 구조와 ARIA 속성을 안전하게 보존하고 복원하는 `setBusyState` 유틸리티를 항상 사용합니다.
