...
## 2026-08-28 - Accessible Required Indicators
**Learning:** When adding visual required indicators (e.g., `*`) to form fields that already use the HTML5 `required` attribute, they cause redundant and confusing screen reader announcements.
**Action:** Always add `aria-hidden="true"` to the visual indicator to prevent redundant and confusing screen reader announcements.
