...
## 2026-08-07 - Contextual ARIA labels for Data Table Actions
**Learning:** Dynamically generated tables with generic action buttons (e.g., "Details", "Status JSON") provide insufficient context for screen reader users when navigating.
**Action:** Always append contextual information (like the specific item name or filename) to generic buttons via `aria-label` attributes to ensure meaningful keyboard and screen reader accessibility.
