...
## 2026-07-03 - 버튼 로딩 상태의 접근성 향상
**Learning:** 비동기 작업 중 버튼의 로딩 상태를 시각적으로만 나타내면 스크린 리더 사용자에게는 작업 진행 상황이 명확히 전달되지 않을 수 있습니다.
**Action:** `aria-busy="true"` 속성을 동적으로 추가 및 제거하여 로딩 상태를 명확히 전달하고 사용자 경험을 개선합니다.
