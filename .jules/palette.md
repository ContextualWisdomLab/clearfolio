...
## 2024-07-20 - Context-Aware ARIA Labels for Repetitive Actions
**Learning:** Repetitive table action buttons (like 'Details' or 'Open') can be confusing for screen reader users without context.
