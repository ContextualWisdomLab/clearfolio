...
## 2026-08-01 - Contextual ARIA labels for repetitive table actions
**Learning:** For repetitive table action buttons or links (e.g., 'Details', 'Open'), screen reader users lack context if all buttons share the same text.
**Action:** Always provide dynamically generated, context-specific `aria-label` attributes that include row-specific identifiers (like the filename) to aid screen reader users.
