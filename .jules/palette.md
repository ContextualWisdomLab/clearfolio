...
## 2026-09-22 - Required Field Visual Indicators
**Learning:** Adding visual `*` indicators to form fields that already use the HTML5 `required` attribute causes screen readers to redundantly and confusingly announce "star" or "asterisk" alongside "required".
**Action:** Always add `aria-hidden="true"` to visual required indicators when the input is already semantically marked as required.
