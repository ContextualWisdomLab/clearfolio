...
## 2026-09-08 - [CRITICAL] Admin Controller Lacks Authorization
**Vulnerability:** AdminController endpoints were globally accessible without any tenant or permission checks.
**Learning:** Even internal admin-sounding endpoints must enforce the same tenant isolation and permission boundaries as public endpoints to prevent cross-tenant data access or manipulation.
**Prevention:** Enforce TenantAccessService checks on all endpoints and explicitly test cross-tenant and missing-token scenarios.
