...
## 2026-08-30 - Added authentication to Admin Controller
**Vulnerability:** Admin Controller endpoints lacked TenantAccessService requirements.
**Learning:** Admin endpoints were exposed without authentication.
**Prevention:** Always secure all API endpoints, including admin endpoints, with proper tenant and permission access controls.
