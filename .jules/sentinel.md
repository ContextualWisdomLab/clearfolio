...
## 2026-07-31 - Admin Endpoint Auth Bypass
**Vulnerability:** AdminController 에 인증이 누락되어 누구나 관리자 작업을 수행할 수 있었습니다.
**Learning:** 모든 컨트롤러 엔드포인트는 TenantAccessService 를 통해 명시적으로 권한을 검사해야 합니다.
**Prevention:** API 엔드포인트 작성 시 항상 @RequestHeader HttpHeaders 를 받고 tenantAccessService.require() 를 호출하도록 합니다.
