...
## 2026-09-15 - [Admin Endpoints Missing Access Controls]
...
**Prevention:** Ensure that all endpoints inject TenantAccessService or equivalent guard checks with explicitly modeled permissions during controller setup.
