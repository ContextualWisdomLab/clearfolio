...
## 2026-09-02 - [Admin Endpoints Missing Authentication]
**Vulnerability:** Admin controller endpoints lacked authentication/authorization checks.
**Learning:** Spring components without explicit manual auth checks default to open, bypassing TenantAccessService entirely.
**Prevention:** Always verify injected TenantAccessService usage in all Spring @RestController classes handling sensitive paths.
