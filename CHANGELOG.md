...
- production readiness가 tenant-claim HMAC와 artifact-token signing secret을
  모두 명시적으로 검증하며, 로컬·buyer-demo 운영 문서는 비밀값 환경 변수
  대신 권한이 제한된 configtree 파일을 사용하도록 정렬했습니다.
