...
| `apache/tika` | Apache-2.0 | Removed from current runtime | Reconsider only when metadata extraction is explicitly in scope and license/SBOM evidence is refreshed. |
