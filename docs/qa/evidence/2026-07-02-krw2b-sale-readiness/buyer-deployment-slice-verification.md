...
| License policy | Current SBOM policy evidence supersedes the original slice count after unused Tika parser package removal. | Pass in engineering-review mode: 60 allowed, 3 review-required, 0 violations. |
...
| License policy | Current SBOM policy evidence supersedes the original slice count after unused Tika parser package removal: 60 allowed, 3 review-required, 0 violations. |
