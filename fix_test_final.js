...
content = content.replace(/\.uri\("\/api\/v1\/admin\/convert\/jobs"\)/g, '.uri("/api/v1/admin/convert/jobs")\n                .header("X-Clearfolio-Tenant-Id", "clearfolio-demo-tenant")\n                .header("X-Clearfolio-Subject-Id", "admin")\n                .header("X-Clearfolio-Permissions", "admin:read")');

content = content.replace(/\.uri\("\/api\/v1\/admin\/convert\/jobs\?deadLettered=true"\)/g, '.uri("/api/v1/admin/convert/jobs?deadLettered=true")\n                .header("X-Clearfolio-Tenant-Id", "clearfolio-demo-tenant")\n                .header("X-Clearfolio-Subject-Id", "admin")\n                .header("X-Clearfolio-Permissions", "admin:read")');

content = content.replace(/\.uri\("\/api\/v1\/admin\/convert\/jobs\?deadLettered=false"\)/g, '.uri("/api/v1/admin/convert/jobs?deadLettered=false")\n                .header("X-Clearfolio-Tenant-Id", "clearfolio-demo-tenant")\n                .header("X-Clearfolio-Subject-Id", "admin")\n                .header("X-Clearfolio-Permissions", "admin:read")');
...
content = content.replace(/^}$/m, negativeTests + '\n}');
