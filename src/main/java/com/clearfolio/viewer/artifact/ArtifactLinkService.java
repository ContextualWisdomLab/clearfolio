...
public class ArtifactLinkService {
    ...
    private ArtifactTokenClaims parseAndVerify(String token) {
        // Optimization: extract payload and signature directly using lastIndexOf and substring
        // to avoid expensive split(), Arrays.copyOf(), and String.join() operations for payload reconstruction.
