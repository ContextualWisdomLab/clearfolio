...
/**
 * Controller for tenant-admin conversion operations.
 */
@RestController
public class AdminController {
    ...
    /**
     * Creates a controller for tenant-admin operations.
     *
    ...
    /**
     * Retrieves conversion jobs owned by the authorized tenant, optionally
     * filtered by dead-letter status.
     *
    ...
    /**
     * Deletes a conversion job owned by the authorized tenant.
     *
    ...
    /**
     * Retries a dead-lettered conversion job owned by the authorized tenant.
     *
     * @param jobId conversion job identifier
     * @param headers request headers carrying tenant claims
    ...
    public ResponseEntity<Void> retryDeadLettered(
        ...
        RetryDeadLetterResult result = conversionService
                .retryDeadLettered(jobId, tenantContext.subjectId());
