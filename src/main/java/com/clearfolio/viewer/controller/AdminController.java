...
public class AdminController {
     ...
     *
     * @param injectedConversionService conversion service
     * @param injectedTenantAccessService tenant access service
     */
    public AdminController(
            final DocumentConversionService injectedConversionService,
            final TenantAccessService injectedTenantAccessService) {
        this.conversionService = injectedConversionService;
        this.tenantAccessService = injectedTenantAccessService;
    }
