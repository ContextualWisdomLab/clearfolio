...
public class AdminController {
     ...
     *
     * @param argConversionSvc conversion service
     * @param argTenantAccessSvc tenant and permission guard
     */
    public AdminController(
            final DocumentConversionService argConversionSvc,
            final TenantAccessService argTenantAccessSvc) {
        this.conversionService = argConversionSvc;
        this.tenantAccessService = argTenantAccessSvc;
    }
