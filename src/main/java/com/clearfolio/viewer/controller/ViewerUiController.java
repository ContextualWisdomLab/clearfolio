...
public class ViewerUiController {
    ...
    // Pre-allocated template parts for viewer shell HTML
    private static final String VIEWER_HTML_PART_1 = """
            <!doctype html>
            <html lang="en">
              <head>
                <meta charset="utf-8" />
    ...
    private static final String VIEWER_HTML_PART_2 = """
            " />
                <meta name="clearfolio-initial-state" content=\"""";
    private static final String VIEWER_HTML_PART_3 = """
            " />
                <meta name="clearfolio-pdfjs-viewer-path" content=\"""";
    private static final String VIEWER_HTML_PART_4 = """
            " />
    ...
    private static String viewerShellHtml(
            final String docId,
            final String initialState) {
        String docIdString = escapeHtmlAttribute(docId);

        // Avoid chained String.replace() calls on large templates by using
        // pre-allocated static string parts and simple concatenation, which is
        // compiled into an efficient StringBuilder allocation.
        return VIEWER_HTML_PART_1
                + docIdString
                + VIEWER_HTML_PART_2
                + initialState
                + VIEWER_HTML_PART_3
