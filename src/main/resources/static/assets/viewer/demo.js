...
function renderHistory(history = loadHistory()) {
  ...
  // ⚡ Bolt: Batch DOM insertions using a DocumentFragment to prevent multiple reflows/repaints.
  // This reduces re-renders and improves rendering performance by batching DOM manipulations.
