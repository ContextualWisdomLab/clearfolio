...
class AdminControllerTest {
    ...
    void setUp() {
        ...
        TenantContext dummyContext = new TenantContext("t1", "s1", Set.of(TenantPermissions.ADMIN));
    ...
    void getAllJobsReturnsAllJobsWhenNoFilterProvided() {
        ConversionJob job1 = new ConversionJob(UUID.randomUUID(), "t1", "s1", "a.pdf", "application/pdf", "hash-a", 100L, 3);
        ConversionJob job2 = new ConversionJob(UUID.randomUUID(), "t1", "s1", "b.pdf", "application/pdf", "hash-b", 100L, 3);
    ...
    void retryDeadLetteredReturnsAcceptedWhenAccepted() {
        UUID jobId = UUID.randomUUID();
        ConversionJob job = new ConversionJob(jobId, "t1", "s1", "a.pdf", "application/pdf", "hash-a", 100L, 3);
    ...
    void retryDeadLetteredReturnsNotFoundWhenNotFound() {
        UUID jobId = UUID.randomUUID();
        // Missing job should be caught by getJob returning empty and throwing 404
