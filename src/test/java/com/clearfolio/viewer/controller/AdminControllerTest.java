...
class AdminControllerTest {
    ...
    void setUp() {
        ...
        TenantContext dummyContext = new TenantContext("test-tenant", "test-subject", Set.of(TenantPermissions.TENANT_CONFIGURE));
        when(tenantAccessService.require(any(), eq(TenantPermissions.TENANT_CONFIGURE))).thenReturn(dummyContext);
    }
