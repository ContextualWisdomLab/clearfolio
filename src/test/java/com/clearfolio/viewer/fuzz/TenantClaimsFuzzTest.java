...
final class TenantClaimsFuzzTest {
    ...
    private final TenantAccessService accessService =
            new TenantAccessService((CredentialRegistryPort) (final String name) -> CredentialRegistryPort.TENANT_CLAIMS_HMAC_SECRET.equals(name) ? java.util.Optional.of("clearfolio-fuzz-claims-secret") : java.util.Optional.empty(), 300L);
